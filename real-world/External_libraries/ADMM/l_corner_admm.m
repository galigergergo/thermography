function [reg_c,rho_c,eta_c] = l_corner_admm(rho,eta,reg_param,U,Ut,s,b,method,M)
...
elseif (strncmp(method,'dsvd',4) || strncmp(method,'dgsv',4))
  ...
  % Compute g = - curvature of L-curve.
  g = lcfun_admm(reg_param,s,beta,xi,1);
  ...
  kappa_max = - lcfun_admm(reg_c,s,beta,xi,1); % Maximum curvature.
